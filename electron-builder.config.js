...
const config = {
  ...
  files: [
    ...
    'electron-main/hardware-tables.cjs',
    'electron-main/cpu-load-worker.js',
    'electron-main/ddr-load-worker.js',
    'electron-main/hardware-load-controller.js',
    'electron-main/ops-health.js',
    'electron-main/probe-attestation.js',
    'electron-main/remote-seed-manifest.js',
    'electron-main/requester-registration.js',
    'electron-main/round-ledger.js',
    'electron-main/runtime-config.js',
    'electron-main/wtc-node.js',
    'electron-main/wtc-accounts.js',
    'electron-main/wtc-address.js',
    'electron-main/wtc-chain.js',
    'electron-main/wtc-consensus.js',
    'electron-main/wtc-mempool.js',
    'electron-main/wtc-nfts.js',
    'electron-main/wtc-governance.js',
    'electron-main/wtc-sale-queue.js',
    'electron-main/wtc-staking-queue.js',
    'electron-main/peer-count-observability.js',
    'electron-main/peer-discovery-observability.js',
    'electron-main/peer-privacy.js',
    'electron-main/peer-self-filter.js',
    'electron-main/local-subnet-discovery.js',
    'electron-main/local-stratum.js',
    'electron-main/stun-client.js',
    'electron-main/tcp-hole-punch.js',
    'electron-main/upnp-port-forward.js',
    'electron-main/protocol-constants.js',
