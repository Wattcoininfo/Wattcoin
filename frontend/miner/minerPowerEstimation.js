...
export function estimateHardwarePower({
  ...
  // Each TDP component is scaled by its own calibration factor (CPU speed ratio,
  // and GPU ALU score ratio).  Blend formula: 0.5 + 0.5×ratio, clamped 0.20–1.20.
  ...
  if (hardware.deviceType === 'Laptop' || isWholeDeviceMiniPcModel) {
    ...
    calibratedPowerW = calibratedCpuTDP + calibratedGpuTDP;
  } else {
