...
const POSTS = [
  ...
  },
  {
    ...
    howToSteps: [
      ...
      'Set Load and Start',
      'Earn Every Block',
      'Combine with CPU or RAM',
    ],
  },
  {
    id: 'enterprise-mining-server-hardware',
    title: 'Enterprise Mining — Server Hardware on Wattcoin',
    desc: 'Deploying server CPUs, RAM, and rack infrastructure for maximum energy contribution on the Wattcoin Proof-of-Energy network.',
    date: 'May 31, 2026',
    schemaType: 'HowTo',
    howToSteps: [
      'Install the Miner on Each Node',
      'Configure CPU and Memory Workloads',
      'Set Duty Cycle',
